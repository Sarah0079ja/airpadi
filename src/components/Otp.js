                     ...
                     <Paper >
                            <form className = {classes.root2} >
                                ...
                                <div className = {classes.reg1} align="center">
                                    ...
                                    <TextField variant="outlined" label="Secure OTP" type="number" id="filled-number" helperText="Resend OTP" value={phone} name="phoneNo" onChange= {(e) =>setPhone(e.target.value)}/>
